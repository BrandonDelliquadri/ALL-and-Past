...
path = 'members'
name_dict = read_dataset.import_data(path)
data_dict = read_dataset.import_data(path)

# input target data
target_path = 'targets'
target_name_dict = read_dataset.import_data(target_path)
target_data_dict = read_dataset.import_data(target_path)
...
for num in range(len(target_data_dict)):
    ...
    sel = selector.random_selector(data_dict)
    select_dict = sel
    index_list = sel   # random select
